...
def main():
    ...
    page_options = ["Home",'About Us',"Recommender System","Recommend with Poster","EDA","Business Solutions",'App Feedback']
    ...
    # Team Member Profiles
        ...
        team_members = [
            ...
            {"name": "Mashoto Kgasago", "role": "Team Lead(Data Scientist)",
